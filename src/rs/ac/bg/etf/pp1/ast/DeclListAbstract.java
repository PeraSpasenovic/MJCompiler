...
public class DeclListAbstract extends DeclList {

    private DeclList DeclList;
    private AbstractClassDecl AbstractClassDecl;

    public DeclListAbstract (DeclList DeclList, AbstractClassDecl AbstractClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclListAbstract(\n");
