...
public class AnyMethodReg extends AnyMethodDeclList {

    private AnyMethodDeclList AnyMethodDeclList;
    private MethodDecl MethodDecl;

    public AnyMethodReg (AnyMethodDeclList AnyMethodDeclList, MethodDecl MethodDecl) {
